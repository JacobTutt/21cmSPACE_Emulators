...
def build_parser() -> argparse.ArgumentParser:
    ...
    """
    parser = argparse.ArgumentParser(description="Run global 21-cm emulator inference.")
    ...
    parser.add_argument("--output", type=str, default="t21_prediction.npz")
    return parser
...
def main() -> None:
    ...
    if args.parameters_file is None or args.z_file is None:
        raise SystemExit("Use --parameters-file and --z-file to run predictions.")
    ...
    np.savez(
        output_path,
        t21=np.asarray(jax.device_get(predictions)),
